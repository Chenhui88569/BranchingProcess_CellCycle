...
data_weibull <- data.frame(
  ...
  Value = c(
    ...
    rweibull(sample_size, shape =   21.963627, scale = 19.870187 ),
    rweibull(sample_size, shape =   21.963627, scale = 5.596279  ),
    rweibull(sample_size, shape =  21.963627 , scale = 4.699444 ),
    sample_data1,
    sample_data2,
...
data_weibull <- data.frame(
  ...
  Value = c(
    ...
    rweibull(sample_size, shape = 14.76384, scale = 15.346355),
    rweibull(sample_size, shape = 14.76384, scale = 43.828203 ),
    rweibull(sample_size, shape = 14.76384, scale = 76.736729 ),
    sample_data1,
