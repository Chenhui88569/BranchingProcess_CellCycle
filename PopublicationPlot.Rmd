...
data_weibull <- data.frame(
  ...
  Value = c(
    rweibull(sample_size, shape =  20.749793, scale = 8.363481 ),
    rweibull(sample_size, shape =  20.749793, scale = 70.867266),
    rweibull(sample_size, shape = 20.749793 , scale = 23.849658),
    sample_data1,
    sample_data2,
