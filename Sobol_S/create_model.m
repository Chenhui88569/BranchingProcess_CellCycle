    ...
    methods
        ...
        function obj = create_model(Model_Index, para_unknown, output_dir)
            ...
            elseif  obj.data_time(end) > 48
                    obj.num_RroundsOfTreatedcells=  3;
                    obj.num_GenOfHealthycells =  2;
            end
        end
        ...
        function  [mat_M_convergence_BeforeTreatment_complete,   mat_M_G1_BeforeTreatment, States_convergence,   M_aftertreatment_col] = M_aftertreatment(obj)
            ...
            if obj.TreatmentEffectOnPhases == 3 % G2M phase cells
                    ...
                    for i = 1:num_CyclingState
                        ...
                        elseif phase == 1
                            mat_M =  G2Mphasedrug_AfterTreatmentBranchingProcess_G1_2( mat_m , G2_arrest_UR,  G2_arrest_FR,  G2_arrest_MS ,   tilde_G1,   tilde_S, g_est2_cdf,   G1_cdf, S_cdf, G2M_cdf,  obj.num_GenOfHealthycells ,obj.StepSize,obj.t_span_AfterTreatment,   obj.num_RroundsOfTreatedcells);
                        elseif phase == 2
            ...
            if obj.TreatmentEffectOnPhases == 2 % S phase cells
                ...
                lambda_d_max_G1 = obj.para_unknown(8);
...
%          exportgraphics( f3 ,  fullfile(obj.outputfile_dir,'Newborn.png' ) ,'Resolution' , 300   );
         ...
         legend({'G1', 'S', 'G2M', 'data G1', 'data S', 'data G2M'}, 'Location', 'northwest', 'FontSize', 15)
         xlabel('Hours')
