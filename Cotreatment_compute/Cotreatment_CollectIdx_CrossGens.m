...
if     AbsolutePhase == 0 % G2M
    state_list  =  state_list(6:end);
elseif     AbsolutePhase == 1 % G1 
    state_list  =  state_list(1:end);
elseif     AbsolutePhase == 2 %S
