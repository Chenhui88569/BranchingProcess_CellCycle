function  CI = TimeCourses_ConfidenceInterval(KineticsPopulation ) 
...
CI = quantile(KineticsPopulation,[0.25,0.75]); 
CI = CI';
CI(CI<0) = 0;
...
% D_vec = vecnorm(Kineticopulation,2,2); %p:2, distance to x axis or the origin in the high-dimensional space
